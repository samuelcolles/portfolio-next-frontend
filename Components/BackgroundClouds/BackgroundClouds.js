...
const BackgroundClouds = () => {
  return (
    <div className={Style.root}>
        ...
        <img className={Style.cloud + " " + Style.cloud5} src="/clouds/MediumCloud3.svg" />
        <img className={Style.cloud + " " + Style.cloud6} src="/clouds/LargeCloud1.svg" />
        <img className={Style.cloud + " " + Style.cloud7} src="/clouds/SmallCloud3.svg" />
        <img className={Style.cloud + " " + Style.cloud8} src="/clouds/MediumCloud4.svg" />
    </div>
  )
}
